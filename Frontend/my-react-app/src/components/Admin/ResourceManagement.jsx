...
<<<<<<< HEAD
            ...
            <div className="rm-tabs">
                <button
                    className={`rm-tab ${activeTab === 'courses' ? 'active' : ''}`}
                    onClick={() => setActiveTab('courses')}
                >
                    <BookOpen size={16} /> Manage Courses
                </button>
                <button
                    className={`rm-tab ${activeTab === 'verification' ? 'active' : ''}`}
                    onClick={() => setActiveTab('verification')}
                >
                    <ShieldCheck size={16} /> Purchase Verification
                </button>
            </div>

            {activeTab === 'verification' && <PurchaseVerification />}
